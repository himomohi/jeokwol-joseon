...
export const NPCS: NpcDef[] = [
  { id: "trainer_musa", name: "검교 박 첨지", role: "trainer", job: "musa", x: -90, y: 30, lines: ["칼끝은 마음을 따른다.", "전직은 한성 무관청과 동문 군영이다. 스무 급이 되면 찾아가거라."] },
  { id: "trainer_gungsoo", name: "각궁 최 사수", role: "trainer", job: "gungsoo", x: -90, y: 70, lines: ["숨과 현을 맞춰라.", "백발은 대숲 오두막, 신기전은 강변 병기창에 있다."] },
  { id: "trainer_dosa", name: "현무관 도사", role: "trainer", job: "dosa", x: 40, y: -90, lines: ["적월이 뜨면 원혼이 걷는다.", "한성 관상감에서 천문을, 폐사 사찰에서 부적을 묻거라."] },
  { id: "trainer_uiwon", name: "무명촌 의원", role: "trainer", job: "uiwon", x: 80, y: -90, lines: ["산 자와 죽은 자를 가리지 마라.", "침은 한성 혜민서, 독객은 약방 지하, 약사는 늪 약초원이다."] },
  { id: "trainer_dojeok", name: "그림자의 노파", role: "trainer", job: "dojeok", x: -180, y: 40, lines: ["발소리는 거짓말이다.", "흑의는 한성 밤골목, 금강은 산속 암자에 숨는다."] },
  { id: "trainer_gibyeong", name: "마구간의 교련관", role: "trainer", job: "gibyeong", x: 200, y: 40, lines: ["말과 한 몸이 되어라.", "염화의 창과 마궁은 산 수련장에서 익힌다."] },
  { id: "shop_weapon", name: "무기전 김 서방", role: "shop", x: -120, y: 20, lines: ["좋은 철을 들여왔다. 골라 보게."] },
  { id: "shop_herb", name: "약재상 한 씨", role: "shop", x: -150, y: 20, lines: ["환약과 영단이 있다. 늪에 들면 해독환을 잊지 말게."] },
  { id: "innkeep", name: "주막 주인", role: "inn", x: 130, y: 20, lines: ["쉬어 가게. 저장은 주막에서 하는 것이 안전하다.", "동녘 벼밭을 지나면 돌담 고갯길이 나온다."] },
  ...
  { id: "innkeep_hansung", name: "한성 주막", role: "inn", x: 2320, y: 24, lines: ["외곽 주막이다. 한성에서 숨을 고르고 스무 급에 교관을 찾거라."] },
  { id: "shop_hansung", name: "한성 전방", role: "shop", x: 2080, y: 16, lines: ["도성 물산이다. 골라 보게."] },
  { id: "hint_pharmacy", name: "약방 심부름꾼", role: "flavor", x: 2240, y: 80, lines: ["독객의 맥은 지하에 있다. 스승은 늪 약초원의 약사에게도 있다.", "해독환 없이 늪에 들지 마라."] },
  { id: "hint_temple", name: "외곽 사당지기", role: "flavor", x: 2300, y: -150, lines: ["부적의 인은 폐사 사찰에 있다. 금강은 암자 노승에게 묻거라."] },

  { id: "trainer_geomgaek", name: "무관청 검교", role: "trainer", job: "musa", advanceJob: "geomgaek", trainerFlag: "trainer_geomgaek", x: 2160, y: -40, lines: ["한 자루로 달을 가르려면 이 마당을 밟아야 한다.", "스무 급, 이 자리의 표식이면 검객의 길을 연다."] },
  { id: "trainer_changbyeong", name: "동문 창교", role: "trainer", job: "musa", advanceJob: "changbyeong", trainerFlag: "trainer_changbyeong", x: 2448, y: 72, lines: ["동문 군영의 창끝이다.", "스무 급이면 창병의 진을 가르친다."] },
  { id: "trainer_sulsa", name: "관상감 천문사", role: "trainer", job: "dosa", advanceJob: "sulsa", trainerFlag: "trainer_sulsa", x: 2100, y: -100, lines: ["별이 적월에 가려도 수는 남는다.", "스무 급에 술사의 원을 연다."] },
  { id: "trainer_myeongui", name: "혜민서 침의", role: "trainer", job: "uiwon", advanceJob: "myeongui", trainerFlag: "trainer_myeongui", x: 2280, y: -70, lines: ["맥은 손끝에서 돈다.", "스무 급이면 명의의 침을 전한다."] },
  { id: "trainer_jagaek", name: "밤골목 흑의", role: "trainer", job: "dojeok", advanceJob: "jagaek", trainerFlag: "trainer_jagaek", x: 2140, y: 110, lines: ["등불이 꺼진 골목이다.", "스무 급, 이 그늘을 지나면 자객이다."] },
  { id: "trainer_dokgong", name: "약방 지하 독객", role: "trainer", job: "uiwon", advanceJob: "dokgong", trainerFlag: "trainer_dokgong", x: 2236, y: 96, lines: ["지하 약방에서 독을 가른다.", "스물두 급. 늪 약초원을 밟아도 같은 표식이다."] },
  { id: "trainer_hwasal", name: "병기창 화포장", role: "trainer", job: "gungsoo", advanceJob: "hwasal", trainerFlag: "trainer_hwasal", x: 2820, y: -740, lines: ["신기전의 연기가 강물에 눕는다.", "스무 급이면 화살사수의 화약을 맡긴다."] },
  { id: "trainer_singung", name: "대숲 백발", role: "trainer", job: "gungsoo", advanceJob: "singung", trainerFlag: "trainer_singung", x: 2760, y: 680, lines: ["백보 밖 숨결이 들린다.", "이 오두막을 찾은 스무 급에게 신궁을 전한다."] },
  { id: "trainer_bujeoksa", name: "폐사 부적승", role: "trainer", job: "dosa", advanceJob: "bujeoksa", trainerFlag: "trainer_bujeoksa", x: 5920, y: 40, lines: ["종이에 신명을 가둔다.", "스무 급, 이 사찰의 표식이면 부적사다."] },
  { id: "trainer_dogul", name: "암자 금강", role: "trainer", job: "dojeok", advanceJob: "dogul", trainerFlag: "trainer_dogul", x: 5820, y: 200, lines: ["무덤의 문을 여는 금강이다.", "스물두 급. 암자를 밟으면 도굴꾼의 눈이 열린다."] },
  { id: "trainer_gichang", name: "염화 창교", role: "trainer", job: "gibyeong", advanceJob: "gichang", trainerFlag: "trainer_gichang", x: 4400, y: -80, lines: ["산 수련장의 창끝이 불꽃을 머금는다.", "스물두 급이면 기창의 길을 허락한다."] },
  { id: "trainer_magung", name: "염화 마궁", role: "trainer", job: "gibyeong", advanceJob: "magung", trainerFlag: "trainer_magung", x: 4440, y: -110, lines: ["달리는 말 위에서 달을 쏜다.", "같은 수련장이다. 스물두 급이면 마궁이다."] },
  { id: "trainer_yaksa", name: "늪 약사", role: "trainer", job: "uiwon", advanceJob: "dokgong", trainerFlag: "trainer_dokgong", x: 3520, y: 200, lines: ["약초원의 독이 약이 된다.", "이 밭을 밟으면 독객의 표식을 받는다."] },
...
export const POI: Record<string, PoiDef> = {
  ...
  mugwan: { x: 2160, y: -40, name: "무관청", flag: "trainer_geomgaek" },
  eastcamp: { x: 2448, y: 72, name: "동문 군영", flag: "trainer_changbyeong" },
  gwansang: { x: 2100, y: -100, name: "관상감", flag: "trainer_sulsa" },
  hyemin: { x: 2280, y: -70, name: "혜민서", flag: "trainer_myeongui" },
  alley: { x: 2140, y: 110, name: "밤골목", flag: "trainer_jagaek" },
  pharmacy: { x: 2236, y: 96, name: "약방 지하", flag: "trainer_dokgong" },
...
export const HUBS: HubDef[] = [
  ...
  { id: "hermitage", x: 5820, y: 220, r: 84, name: "암자", rest: true, layout: "camp" },
];
